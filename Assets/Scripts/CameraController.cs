...
public class CameraController : MonoBehaviour
{
    ...
    private IEnumerator Move()
    {
        ...
        p_TargetTransform = GameObject.Find("CameraPointA").transform;
        ExecuteMove();
        ...
        p_TargetTransform = GameObject.Find("CameraPointB").transform;
        ExecuteMove();

        yield return new WaitForSeconds(10.0f);
        p_TargetTransform = GameObject.Find("CameraPointC").transform;
        ExecuteMove();
    ...
    public void ExecuteMove()
    {
        ...
        p_Trigger = Observable
            ...
            intervalTimeSpan =>
            {
                ...
                Camera.main.transform.rotation *= Quaternion.Euler(0f, 0f, 45f);
